...
if [ ${#depsToInstall[@]} -gt 0 ]; then
  echo "This program will install the following dependencies: $depsToInstall" | fold
...
echo "Please enter a primary title that will be displayed as an ascii text banner generated by figlet." | fold

read -p "Primary title: " title
confirm "Are you sure you want the primary title to be \"$title\"?" | fold || {
  exit 0
}

echo "Please enter a figlet font name for the primary title of the motd message. A complete list can be found here: http://www.figlet.org/fontdb.cgi" | fold
